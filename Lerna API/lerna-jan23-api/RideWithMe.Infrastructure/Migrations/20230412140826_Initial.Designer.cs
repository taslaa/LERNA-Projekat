...
namespace RideWithMe.Infrastructure.Migrations
{
    ...
    [Migration("20230412140826_Initial")]
            ...
            modelBuilder.Entity("RideWithMe.Core.Ride", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DriverId = 1,
                            DriverVehicleId = 1,
                            EndDateTime = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
                            MaxPassengersCount = 3,
                            Notes = "Nesto",
                            PaymentType = 1,
                            Price = 50m,
                            StartDateTime = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("RideWithMe.Core.RideMilestone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CityId = 1,
                            CreatedAt = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            DateTime = new DateTime(2023, 2, 1, 0, 0, 0, 0, DateTimeKind.Local),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("RideWithMe.Core.Ride", b =>
                {
                    ...
                    b.HasOne("RideWithMe.Core.UserVehicle", "DriverVehicle")
                        .WithMany("Rides")
