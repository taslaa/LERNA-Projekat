...
export default function ThemeSwitcher() {
  ...
  useEffect(() => {
    ...
    document.documentElement.setAttribute("data-bs-theme", theme ? theme : "light");
  }, []);
  ...
  return (
    <li className="nav-item dropdown ms-3">
      ...
      <ul className="dropdown-menu min-w-auto dropdown-menu-end" aria-labelledby="bd-theme">
        <li className="mb-1">
          <button onClick={() => changeTheme("light")} type="button" className={`dropdown-item d-flex align-items-center ${currentTheme === "light" ? "active" : ""}`} data-bs-theme-value="light">
        ...
        <li className="mb-1">
          <button onClick={() => changeTheme("dark")} type="button" className={`dropdown-item d-flex align-items-center ${currentTheme === "dark" ? "active" : ""}`} data-bs-theme-value="dark">
